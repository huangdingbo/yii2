...
abstract class Application extends Module
{
    ...
    protected function bootstrap()
    {
        if ($this->extensions === null) {
            ...
            //添加项目vendor的extension
            $project_file = Yii::getAlias('@project_vendor/extensions/extensions.php');
            $vendor_extensions = is_file($file) ? include $file : [];
            $project_vendor_extensions = is_file($project_file) ? include $project_file : [];
            $this->extensions = array_merge($vendor_extensions,$project_vendor_extensions);
        }
